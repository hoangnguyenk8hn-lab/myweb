...
- Kết quả commit luôn là `elements[]`, kể cả construction chỉ tạo một đối tượng. Nhờ vậy Tangent có thể dùng Shift để trả cả hai nhánh trong đúng một transaction, và construction nhiều đối tượng sau này không cần sửa contract của canvas.
